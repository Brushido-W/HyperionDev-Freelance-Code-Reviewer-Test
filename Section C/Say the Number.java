...
public class SayTheNumber {
    ...
    //1,000,000,000,000,000 quadrillion
        ...
        if (n < 100000) {
            // retuns any number divisible by a Thousand as that number followed by a Thousand and the following converted strings
            return convert(n / 1000) + " Thousand," + ((n % 1000 != 0) ? " " : "") + convert(n % 1000);
        }
        
        // if the number is less than 1000000
        if (n < 1000000) {
            // retuns any number divisible by a Hundred Thousand as that number followed by a Hundred Thousand and the following converted strings
            return convert(n / 100000) + " Hundred Thousand," + ((n % 100000 != 0) ? " " : "") + convert(n % 100000);
        }

        // if the number is less than 100000000
        if (n < 100000000L) {
            // retuns any number divisible by a million as that number followed by a million and the following converted strings
            return convert(n / 1000000) + " Million," + ((n % 1000000 != 0) ? " " : "") + convert(n % 1000000);
        }
        
        // if the number is less than 1000000000000
        if (n < 1000000000000L) {
            // retuns any number divisible by a billion as that number followed by a billion and the following converted strings
        ...
        if (n < 1000000000000000L) {
            // retuns any the number divisible by a trillion as that number followed by a trillion and the following converted strings 
            return convert(n / (int)1000000000000L) + " Trillion," + ((n % 1000000000000L != 0) ? " " : "") + convert(n % (int)1000000000000L);
        }
        
        // if the user enters any other number it will return "Please enter a number from 0 to 999,999,999,999,999"
